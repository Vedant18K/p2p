...
public class Base_Class_Customer {
    ...
    public void setup() {
        ...
        driver.get("https://lending.wadiaa.com/customer/login");
    }
	
    @BeforeClass
    public void login() throws InterruptedException {
    	Lending_Login_Page lendingLoginPage = new Lending_Login_Page(driver);
        String expectedUrl = "https://lending.wadiaa.com/customer/login";
        WebDriverWait wait = new WebDriverWait(driver, 50); // Adjust timeout as needed
        wait.until(ExpectedConditions.urlToBe(expectedUrl));
        lendingLoginPage.testWadiaEmailInputField();
        lendingLoginPage.testWadiaPasswordField();
        lendingLoginPage.testWadiaLoginButton();
    }
